...
import { getFirestore, collection, addDoc, getDocs, query, orderBy, deleteDoc, doc } from 'firebase/firestore'; // Updated imports
...
export { collection, addDoc, getDocs, query, orderBy, deleteDoc, doc };
